...
jQuery(document).ready(function ($) {
     ...
     */
    (cuztomUI = function cuztomUI(object) {
        var object = $(object);
        ...
        // Helpers
        (cuztomWysiwyg = function cuztomWysiwyg() {
...
var vCuztomSortable = {
    ...
    methods: {
        ...
        postAjax: function postAjax(options, params) {
            var vm = this;
...
vCuztomMedia = {
    ...
    computed: {
        ...
        _attachment: function _attachment() {
...
Vue.component('v-cuztom-file', {
    ...
    methods: {
        ...
        setPreview: function setPreview(attachment) {
        ...
        vCuztom.each(function (index, element) {
            ...
            new Vue({
                ...
                methods: {
                    ...
                    reloadVue: function reloadVue() {
                        this.$forceUpdate();
                    },

                    reloadCuztomUI: function reloadCuztomUI() {
