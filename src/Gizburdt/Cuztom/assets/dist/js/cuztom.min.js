...
var cuztomUI;(cuztomUI=function(t){t=$(t),$(".js-cuztom-datepicker",t).map(function(){return $(this).datetimepicker({timepicker:!1,format:$(this).data("date-format")})}),$(".js-cuztom-timepicker",t).map(function(){return $(this).datetimepicker({datepicker:!1,format:$(this).attr("data-time-format")})}),$(".js-cuztom-datetimepicker",t).map(function(){return $(this).datetimepicker({timeFormat:$(this).data("time-format"),dateFormat:$(this).data("date-format")})}),$(".js-cuztom-colorpicker",t).wpColorPicker(),$(".js-cuztom-tabs",t).tabs(),$(".js-cuztom-slider",t).slider(),$(".js-cuztom-accordion",t).accordion(),$(".js-cuztom-sortable",t).sortable({handle:".cuztom-handle-sortable a"})})(document);
