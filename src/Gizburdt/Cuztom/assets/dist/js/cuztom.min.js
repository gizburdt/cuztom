...
doc.on("click",".js-cuztom-ajax-save",function(t){var o=$(this),a=o.closest(".js-cuztom"),e=o.closest(".js-cuztom-field"),c=e.attr("data-id"),i=a.attr("data-box-id"),d=a.attr("data-object-id"),r=a.data("meta-type"),s=e.find(".cuztom-input"),l=s.val(),u={action:"cuztom_save_field",cuztom:{value:l,box_id:i,field_id:c,meta_type:r,object_id:d}};console.log(s),$.post(Cuztom.ajax_url,u,function(t){var t=$.parseJSON(t),o=s.css("border-color");t.status&&s.animate({borderColor:"#60b334"},1200,function(){s.animate({borderColor:o})})}),t.preventDefault()}); });