...
var cuztomUI;(cuztomUI=function(t){t=$(t),$(".js-cuztom-datepicker",t).map(function(){return $(this).datetimepicker({scrollInput:!1,timepicker:!1,format:$(this).data("date-format")})}),$(".js-cuztom-timepicker",t).map(function(){return $(this).datetimepicker({scrollInput:!1,datepicker:!1,format:$(this).attr("data-time-format")})}),$(".js-cuztom-datetimepicker",t).map(function(){return $(this).datetimepicker({scrollInput:!1,format:$(this).data("date-format")+" "+$(this).data("time-format")})}),$(".js-cuztom-colorpicker",t).wpColorPicker(),$(".js-cuztom-tabs",t).tabs(),$(".js-cuztom-slider",t).slider(),$(".js-cuztom-accordion",t).accordion(),$(".js-cuztom-sortable",t).sortable({handle:".cuztom-handle-sortable a"})})(document);
doc.on("click",".js-cuztom-add-sortable",function(t){var e=$(this),o=$(".js-cztm").attr("data-box-id"),a="bundle"==e.attr("data-sortable-type"),c=e.attr("data-field-id"),d=$(".cuztom-field#"+c),i=d.find(".js-cztm-counter"),n=i.find(".js-current"),r=(i.find(".js-max"),d.find(".cuztom-sortable")),m=r.find(".cuztom-sortable-item").length,s=m,l={action:a?"cuztom_add_bundle_item":"cuztom_add_repeatable_item",cuztom:{box_id:o,field_id:c,count:m,index:s}};$.post(Cuztom.ajax_url,l,function(t){var t=$.parseJSON(t);t.status?(r.append(t.item),n.text(m+1)):alert(t.message),cuztomUI(document)}),t.preventDefault()}),doc.on("click",".js-cztm-remove-sortable",function(){var t=$(this),e=t.closest(".cuztom-sortable-item"),o=e.closest(".cuztom-sortable"),a=o.closest(".cuztom-field"),c=a.attr("data-field-id"),d=($('.cuztom-control[data-control-for="'+c+'"]'),o.find(".cuztom-sortable-item").length),i=a.find(".js-cztm-counter"),n=i.find(".js-current");i.find(".js-max");return e.remove(),n.text(d-1),1==o.find(".cuztom-sortable-item").length&&o.find(".cuztom-sortable-item").last().find(".js-cztm-remove-sortable").remove(),!1});
