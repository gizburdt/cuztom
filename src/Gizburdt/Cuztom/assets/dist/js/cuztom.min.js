...
var cuztomUI;(cuztomUI=function(t){t=$(t),$(".js-cztm-datepicker",t).map(function(){return $(this).datepicker({dateFormat:$(this).data("date-format")})}),$(".js-cztm-timepicker",t).map(function(){return $(this).timepicker({timeFormat:$(this).data("time-format")})}),$(".js-cztm-datetimepicker",t).map(function(){return $(this).datetimepicker({timeFormat:$(this).data("time-format"),dateFormat:$(this).data("date-format")})}),$(".js-cztm-colorpicker",t).wpColorPicker(),$(".js-cztm-tabs",t).tabs(),$(".js-cztm-slider",t).slider(),$(".js-cztm-accordion",t).accordion(),$(".js-cztm-sortable",t).sortable({handle:".cuztom-handle-sortable a"})})(document);
