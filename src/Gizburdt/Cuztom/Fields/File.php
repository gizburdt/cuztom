...
class File extends Field
{
    ...
    public function _output_input($value = null)
    {
        ...
        ?>
        <input type="button" id="<?php echo $this->get_id();
        ?>" class="button button-small js-cuztom-upload" data-media-type="file" value="<?php _e('Select file', 'cuztom');
        ?>" />
        ...
        ?>
        <span class="cuztom-preview"><?php echo $file;
        ?></span>
