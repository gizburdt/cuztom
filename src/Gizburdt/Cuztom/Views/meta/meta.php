<?php if (! empty($box->data)) : ?>
    ...
    <div class="cuztom cuztom-<?php echo $box->get_meta_type(); ?> js-cuztom" data-box-id="<?php echo $box->id; ?>" data-object-id="<?php echo $box->get_object(); ?>" data-meta-type="<?php echo $box->get_meta_type(); ?>">
