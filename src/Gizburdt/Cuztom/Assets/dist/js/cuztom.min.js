...
doc.on("click",".js-cuztom-add-sortable",function(t){var e=$(this),o=e.closest(".js-cuztom"),s=o.data("box-id"),a=e.data("sortable-type");if("repeatable"==a)var c=e.closest(".js-cuztom-field"),d=c.find(".js-cuztom-counter"),n="cuztom_add_repeatable_item";else var u=e.closest(".js-cuztom-control"),i=u.data("control-for"),d=u.find(".js-cuztom-counter"),c=$('.js-cuztom-field[data-id="'+i+'"]'),n="cuztom_add_bundle_item";var r=c.find(".js-cuztom-sortable"),l=d.find(".js-current"),m=(d.find(".js-max"),r.find(".js-cuztom-sortable-item").length),f=m,z=Cuztom.ajax_url,j={action:n,security:Cuztom.wp_nonce,cuztom:{box:s,field:e.data("field-id"),count:m,index:f}};$.post(z,j,function(t){var t=$.parseJSON(t);t.status?(r.append(t.item),l.text(m+1)):alert(t.message),cuztomUI(document)}),t.preventDefault()}),doc.on("click",".js-cuztom-remove-sortable",function(t){var e=$(this),o=e.closest(".js-cuztom"),s=(o.data("box-id"),e.closest(".js-cuztom-sortable-item")),a=e.closest(".js-cuztom-field"),c=a.find(".js-cuztom-sortable"),d=(e.data("sortable-type"),a.find(".js-cuztom-counter")),n=d.find(".js-current"),u=(d.find(".js-max"),c.find(".js-cuztom-sortable-item").length);s.remove(),n.text(u-1),t.preventDefault()});
