...
if (! Cuztom::isEmpty($value)) {
    ...
    $file       = '<span class="cuztom-media__mime mime--'.$mime.'"><a target="_blank" href="'.$attachment.'">'.$name.'</a></span>';
} else {
    $file       = '';
}
...
<span class="cuztom-media__preview js-cuztom-media-preview"><?php echo $file; ?></span>
