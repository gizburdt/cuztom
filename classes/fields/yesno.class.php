...
class Cuztom_Field_Yesno extends Cuztom_Field
{
	function _output( $value, $object )
	{
		...
		$output .= '<div class="cuztom-checkbox-wrap">';
			$output .= '<input type="radio" name="cuztom[' . $this->id_name . ']" id="' . $this->id_name . $this->after_id . '_yes" value="yes" ' . ( ! empty( $value ) ? checked( $value, 'yes', false ) : checked( $this->default_value, 'yes', false ) ) . ' class="cuztom-input" /> ';
