...
class Cuztom_Field_File extends Cuztom_Field
{
	function _output( $value )
	{
		...
		$output = '<div class="cuztom_button_wrap">';
			...
			$output .= sprintf( '<input id="upload_file_button" type="button" class="button cuztom_button cuztom_upload cuztom_file js-cuztom-upload" value="%s" />', __( 'Select file', CUZTOM_TEXTDOMAIN ) );
